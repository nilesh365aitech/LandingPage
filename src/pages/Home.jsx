...
export const ScheduleMeetingModal = ({ isOpen, onClose, bot, mode }) => {
...
export const BotPurchaseModal = ({ isOpen, onClose, bot }) => {
      ...
      bots: [
        {
          ...
          description:
            "Seamlessly handles inquiries, books appointments, and provides personalized follow-ups across communication channels.",
          price: 9,
          image: healthcare,
...

    {
      ...
      bots: [
        ...
        },
        {
          ...
          description:
            "Manages real estate appointments with precision, ensuring efficient communication and user detail tracking.",
          price: 9,
          image: realestate2,
      ...
      bots: [
        {
          ...
          description:
            "Automates lead qualification, schedules appointments, and provides intelligent support for car sales processes.",
          price: 9,
          image: Buycar,
        ...
        },
        {
          ...
          description:
            "Matches customers with ideal vehicles, manages appointments, and streamlines the car sales inquiry process.",
          price: 9,
          image: sellcar,
      ...
      bots: [
        {
          ...
          description:
            "Automates skill assessments with instant results, tracking performance through detailed interviews and analysis.",
          price: 9,
          image: hr,
        ...
        },
        {
          ...
          description:
            "Conducts automated interviews, analyzes responses, and generates comprehensive reports for HR decision-making.",
          price: 9,
          image: hr,
          videoUrl: "https://www.youtube.com/embed/JGN5JVHBwQw",
        ...
        },
        {
          ...
          description:
            "Streamlines interview scheduling, sends reminders, and keeps candidate information organized.",
          price: 9,
          image: hr,
      ...
      bots: [
        {
          ...
          description:
            "Efficiently manages solar site visit bookings, provides product information, and ensures smooth follow-ups.",
          price: 9,
          image: solar,
        ...
        },
        {
          ...
          description:
            "Simplifies appointment scheduling for playschools with efficient communication and parent-friendly interfaces.",
          price: 9,
          image: playschoool,
        ...
        },
        {
          ...
          description:
            "Streamlines hospital appointment booking with timely follow-ups and efficient patient communication.",
          price: 9,
          image: healthcare,
        ...
        },
        {
          ...
          description:
            "Manages demo class scheduling and student engagement with seamless communication tools.",
          price: 9,
          image: english,
